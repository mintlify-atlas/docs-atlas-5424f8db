...
description: "Configure @nuxt-alt/auth with Laravel JWT for token-based authentication using the laravelJWT scheme with JWT access tokens and refresh token support."
---
